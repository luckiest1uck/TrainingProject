...
INSERT INTO public.product_reviews (id, product_id, user_id, text, rating, likes_count, dislikes_count) VALUES ('b1000008-0000-0000-0000-000000000003', '6d77f8a9-e640-4d2e-ba2c-b7db8ab2c123', '44444444-4444-4444-4444-444444444444', 'Weak sample quality. Tastes more like cold milk than iced coffee.', 2, 0, 0);
...
-- Sample Product (cc0b6e5d) — existing: 33333333(2)
INSERT INTO public.product_reviews (id, product_id, user_id, text, rating, likes_count, dislikes_count) VALUES ('b1000019-0000-0000-0000-000000000001', 'cc0b6e5d-71f1-44cd-8a5b-1bdb978b5ca6', '11111111-1111-1111-1111-111111111111', 'Useful sample item with clear behavior. My summer staple.', 5, 0, 0);
INSERT INTO public.product_reviews (id, product_id, user_id, text, rating, likes_count, dislikes_count) VALUES ('b1000019-0000-0000-0000-000000000002', 'cc0b6e5d-71f1-44cd-8a5b-1bdb978b5ca6', '44444444-4444-4444-4444-444444444444', 'Fine but nothing that stands out from any other sample drink.', 3, 0, 0);
INSERT INTO public.product_reviews (id, product_id, user_id, text, rating, likes_count, dislikes_count) VALUES ('b1000019-0000-0000-0000-000000000003', 'cc0b6e5d-71f1-44cd-8a5b-1bdb978b5ca6', '55555555-5555-5555-5555-555555555555', 'Ice watered it down completely. No sample quality left.', 1, 0, 0);

-- Seasonal Blend (aa1d3e8f) — existing: 44444444(5), 55555555(5), 22222222(5), 33333333(4)
