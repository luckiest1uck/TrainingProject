...
LABEL org.opencontainers.image.title="TrainingProject Backend" \
      org.opencontainers.image.description="TrainingProject backend service" \
      org.opencontainers.image.version="${IMAGE_VERSION}" \
      org.opencontainers.image.vendor="TrainingProject Team"
